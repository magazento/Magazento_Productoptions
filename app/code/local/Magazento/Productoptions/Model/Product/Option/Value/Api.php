...
class Magazento_Productoptions_Model_Product_Option_Value_Api extends Mage_Catalog_Model_Product_Option_Value_Api // extends Mage_Catalog_Model_Api_Resource
{
       /**
    ...
    public function info($valueId, $store = null)
    {
        ...
        $productOptionValue = Mage::getModel('productoptions/product_option_value')->load($valueId);
    ...
    public function add($optionId, $data, $store = null)
    {
        ...
        $optionValueModel = Mage::getModel('productoptions/product_option_value');
    ...
    public function remove($valueId)
    {
        ...
        $optionValue = Mage::getModel('productoptions/product_option_value')->load($valueId);
    ...
    {
        /** @var $option Mage_Catalog_Model_Product_Option */
        $option = Mage::getModel('productoptions/product_option');
