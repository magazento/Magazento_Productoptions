 ...
 */
class Magazento_Productoptions_Model_Mysql4_Product_Option_Collection extends Mage_Catalog_Model_Resource_Product_Option_Collection //extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
    ...
    {
        $productOptionTitleTable = $this->getTable('productoptions/product_option_title');
    ...
    {
        $productOptionPriceTable = $this->getTable('productoptions/product_option_price');
        $adapter        = $this->getConnection();
    ...
    public function addValuesToResult($storeId = null)
    {
        ...
        if (!empty($optionIds)) {
            ...
            $values = Mage::getModel('productoptions/product_option_value')
                ->getCollection()
                ->addTitleToResult($storeId)
