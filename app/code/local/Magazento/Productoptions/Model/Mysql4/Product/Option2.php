 ...
 */
class Magazento_Productoptions_Model_Mysql4_Product_Option2 extends Mage_Core_Model_Mysql4_Abstract
{
    ...
    public function deletePrices($option_id)
    {
        ...
        $this->_getWriteAdapter()->delete(
            $this->getTable('productoptions/product_option_price'),
            $condition);
    ...
    public function deleteTitles($option_id)
    {
        ...
        $this->_getWriteAdapter()->delete(
            $this->getTable('productoptions/product_option_title'),
            $condition);
    ...
    public function getSearchableData($productId, $storeId)
    {
        ...
        $select = $this->_getReadAdapter()->select()
            ...
            ->join(
                array('option_title_default' => $this->getTable('productoptions/product_option_title')),
                'option_title_default.option_id=option.option_id AND option_title_default.store_id=0',
                array())
            ->joinLeft(
                array('option_title_store' => $this->getTable('productoptions/product_option_title')),
        ...
        $select = $this->_getReadAdapter()->select()
            ->from(array('option' => $this->getMainTable()), null)
            ->join(
                array('option_type' => $this->getTable('productoptions/product_option_type_value')),
                'option_type.option_id=option.option_id',
                array())
            ->join(
                array('option_title_default' => $this->getTable('productoptions/product_option_type_title')),
                'option_title_default.option_type_id=option_type.option_type_id AND option_title_default.store_id=0',
                array())
            ->joinLeft(
                array('option_title_store' => $this->getTable('productoptions/product_option_type_title')),
