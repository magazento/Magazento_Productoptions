 ...
 */
class Magazento_Productoptions_Model_Mysql4_Product_Option_Value extends Mage_Catalog_Model_Resource_Product_Option_Value //extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    public function deleteValues($optionTypeId)
    {
        ...
        $this->_getWriteAdapter()->delete(
            $this->getTable('productoptions/product_option_type_price'),
            $condition
        );

        $this->_getWriteAdapter()->delete(
            $this->getTable('productoptions/product_option_type_title'),
            $condition
        );
    }
