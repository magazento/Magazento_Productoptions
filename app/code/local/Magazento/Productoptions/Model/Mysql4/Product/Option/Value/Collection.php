 ...
 */
class Magazento_Productoptions_Model_Mysql4_Product_Option_Value_Collection extends Mage_Catalog_Model_Resource_Product_Option_Value_Collection
    //extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    public function addTitlesToResult($storeId)
    {
        ...
        $optionTypePriceTable = $this->getTable('productoptions/product_option_type_price');
        $optionTitleTable     = $this->getTable('productoptions/product_option_type_title');
    ...
    {
        $optionTypeTable = $this->getTable('productoptions/product_option_type_price');
